...
export const DEFAULT_AGENT_REGISTRY: AgentRegistryEntry[] = [
  ...
  {
    id: "supplement.reddit",
    label: "Reddit Supplement Agent",
    stage: "supplement",
    mode: "topics",
    enabledByDefault: true,
  },
  {
    id: "supplement.earnings_week",
    label: "Earnings Week Table Agent",
    stage: "supplement",
    mode: "topics",
    enabledByDefault: true,
  },
  {
    id: "supplement.earnings_calls",
    label: "Earnings Call Hubs Agent",
    stage: "supplement",
    mode: "topics",
    enabledByDefault: true,
  },
  {
    id: "supplement.bottom_review",
    label: "Supplement Review Agent",
    stage: "supplement",
    mode: "topics",
    enabledByDefault: true,
  },
